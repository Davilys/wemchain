        ...
        {loading ? (
          ...
          <AnimatedList className="space-y-3" staggerDelay={0.05}>
            {filteredRegistros.map((registro) => {
              ...
              return (
                <Card key={registro.id} className="border-border hover:border-primary/30 transition-colors">
                  <CardContent className="p-3 sm:p-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      {/* Left: Icon + Info */}
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                        ...
                        {/* Status - visible on mobile next to info */}
                        <Badge className={`${statusConfig.className} font-body text-xs sm:hidden`}>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0 ml-auto sm:ml-0">
                        <Badge className={`${statusConfig.className} font-body text-xs hidden sm:flex`}>
                          <StatusIcon className="h-3 w-3 mr-1" />
                          {statusConfig.label}
                        </Badge>
