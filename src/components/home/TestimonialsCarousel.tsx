...
function TestimonialCard({ testimonial }: { testimonial: typeof testimonials[0] }) {
  return (
    <div className="flex-shrink-0 w-[340px] md:w-[380px] p-6 rounded-2xl bg-card border border-border/50 shadow-sm hover:shadow-md transition-shadow">
      {/* Stars and Quote */}
      ...
      {/* Testimonial Text */}
      <p className="text-foreground/90 text-sm md:text-base leading-relaxed mb-6 min-h-[80px]">
        "{testimonial.text}"
      </p>
