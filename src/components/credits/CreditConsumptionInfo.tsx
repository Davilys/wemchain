...
export const CreditConsumptionInfo = forwardRef<HTMLDivElement, CreditConsumptionInfoProps>(
  ({ variant = "default" }, ref) => {
    if (variant === "compact") {
      return (
        <div ref={ref} className="flex items-center gap-2 text-xs text-muted-foreground font-body">
    ...
    return (
      <div ref={ref} className="p-4 rounded-lg bg-primary/5 border border-primary/10">
...
CreditConsumptionInfo.displayName = "CreditConsumptionInfo";
